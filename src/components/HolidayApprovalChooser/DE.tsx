...
function DE(props) {
  ...
  let draggable = !props.category || (props.category === "staff" && props.de.isStaff) || (props.category === "dept" && !props.de.isStaff);

  return <div className={"de " + (props.de.isStaff ? "emp" : "dep") + (props.isOpen ? " open" : "") + (isEmptyDep ? " empty" : "")}>
    <span draggable={draggable} className={"item" + (isDragged ? " dragged-item" : "")} onMouseUp={props.de.isStaff ? props.handleClickEmployee.bind(null, props.de) : toggleFolder} onMouseDown={props.handleMouseDown.bind(null, props.de)} onDragStart={props.firefoxDragStart} onDragEnd={props.handleDragEnd}>
