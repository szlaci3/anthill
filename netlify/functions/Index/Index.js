...
const handler = async (event, context) => {
  try {
    ...
    switch(api) {
      case "customerIndex": response = {"onjobCount":"445","waitOnJob":"8","contract_to_expire":"424","unexecuted_contract":"32","contract_try_end":"10"}; break;
      ...
      case "getStatistics": response.data = 21; break;
    }
